        ...
        >
            ...
            >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    ...
                    {/* 로컬 데이터 마이그레이션 */}
                    {legacyDataInfo && (legacyDataInfo.hasArtworks || legacyDataInfo.hasSettings) && (
                        <div
                            style={{
                                marginTop: "24px",
                                padding: "24px",
                                background: settings.theme === "black" ? "#3a1a1a" : "#fff0f0",
                                borderRadius: "16px",
                                border: settings.theme === "black" ? "2px solid #8b2222" : "2px solid #dc143c",
                            }}
                        >
                            <h3 style={{
                                fontSize: "20px",
                            ...
                            <p style={{
                                ...
                                이 기기에 저장된 로컬 데이터를 Supabase 클라우드로 이전합니다.
                                <br />
                                • 작품 데이터: {legacyDataInfo.artworksCount}개 발견
                                <br />
                                • 설정 데이터: {legacyDataInfo.hasSettings ? "있음" : "없음"}
                            </p>
                            ...
                            {migrationResult && (
                                <div style={{
                                    ...
                                    marginBottom: "16px",
                                    borderRadius: "8px",
                                    background: migrationResult.success ? "#22c55e" : "#dc2626",
                                    color: "#fff",
                                }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    fontSize: "16px",
                                    fontWeight: 600,
                                    background: settings.theme === "black" ? "#8b2222" : "#dc143c",
                                    color: "#fff",
                                    border: "none",
                                    borderRadius: "12px",
