...
const VIP_NAME = "VIP 04";
const VIP_PATH = "/gallery-vip-04";
        ...
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ background: "#fafafa" }}>
                <div className="w-full max-w-md mx-4 p-8 rounded-2xl" style={{ background: "#fff", boxShadow: "0 4px 20px rgba(0,0,0,0.1)" }}>
                    <div style={{ width: "60px", height: "60px", borderRadius: "50%", background: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px", color: "#fff", fontSize: "24px", fontWeight: 700 }}>04</div>
                    ...
                    <button onClick={handleLogin} style={{ width: "100%", padding: "16px", fontSize: "16px", fontWeight: 600, color: "#fff", background: "#ec4899", border: "none", borderRadius: "12px", cursor: "pointer" }}>로그인</button>
        ...
        <div className="min-h-screen" style={{ background: bgColor, color: textColor }}>
            <header style={{ padding: "20px 24px", borderBottom: `1px solid ${borderColor}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: "14px", fontWeight: 700 }}>04</div>
            ...
            <main className="max-w-2xl mx-auto" style={{ padding: "32px 24px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    ...
                    <button onClick={handleSave} disabled={isSaving} style={{ width: "100%", padding: "18px", fontSize: "16px", fontWeight: 600, color: "#fff", background: isSaving ? "#94a3b8" : "#ec4899", border: "none", borderRadius: "12px", cursor: isSaving ? "not-allowed" : "pointer" }}>{isSaving ? "저장 중..." : "설정 저장"}</button>
                </div>
